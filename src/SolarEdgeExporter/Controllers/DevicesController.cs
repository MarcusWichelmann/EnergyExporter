...
public class DevicesController : ControllerBase {
    ...
    public ActionResult<Inverter> GetInverter(int id) =>
        _deviceService.Devices.OfType<Inverter>().ElementAtOrDefault(id) ?? (ActionResult<Inverter>)NotFound();
    ...
    public ActionResult<Meter> GetMeter(int id) =>
        _deviceService.Devices.OfType<Meter>().ElementAtOrDefault(id) ?? (ActionResult<Meter>)NotFound();
    ...
    public ActionResult<Battery> GetBatteries(int id) =>
        _deviceService.Devices.OfType<Battery>().ElementAtOrDefault(id) ?? (ActionResult<Battery>)NotFound();
}
